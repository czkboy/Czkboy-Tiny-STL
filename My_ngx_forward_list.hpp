...
#ifndef My_ngx_forward_list_hpp
#define My_ngx_forward_list_hpp
...
void* Flist_getlast(Forward_List*l)
{
    ...
    else
    {
        ...
        flag = i->ndata;
        --flag;
        return (char *)i->data + l->size * flag;
    }

    return (char *)l->last->data + l->size * flag;
}
...
int Flist_empty(Forward_List*l)
{
    
    return    l == NULL || l->part == NULL || l->part->ndata == 0;
}
